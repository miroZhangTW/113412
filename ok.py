afrom flask import Flask, request, render_template
...
def get_products():
    ...
    try:
        ...
        products = [{'id': row[0], 'name': row[1]} for row in results]  # 假設第一列是 id，第二列是 name
        
        return render_template('products.html', products=products)  # 渲染模板顯示產品
